...
"noty_layout_center"==a.options.layout)&&b.noty.reCenter(c)});c.bind("noty.setType",function(d,e){c.removeClass(c.data("noty_options").type);e=c.data("noty_options").cssPrefix+e;c.data("noty_options").type=e;c.addClass(e);("noty_layout_topCenter"==a.options.layout||"noty_layout_center"==a.options.layout)&&b.noty.reCenter(c)});c.bind("noty.getId",function(){return c.data("noty_options").id});c.one("noty.close",function(){var d=c.data("noty_options");if(d.onClose)d.onClose();d.modal&&b(".noty_modal").fadeOut("fast",
...
d.outerWidth())/2+"px"})};b.noty.clearQueue=function(){b.noty.queue=[]};var i=window.alert;b.noty.consumeAlert=function(d){window.alert=function(e){d?d.text=e:d={text:e};b.noty(d)}};b.noty.stopConsumeAlert=function(){window.alert=i};b.noty.queue=[];b.noty.growls=["noty_layout_topLeft","noty_layout_topRight","noty_layout_bottomLeft","noty_layout_bottomRight"];b.noty.available=!0;b.noty.defaultOptions={layout:"top",theme:"noty_theme_default",animateOpen:{height:"toggle"},animateClose:{height:"toggle"},
